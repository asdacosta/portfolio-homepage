...
<img src="https://img.shields.io/badge/Babel-F7B93E?style=for-the-badge&logo=babel&logoColor=black" alt="Babel badge">
    <h4><a href="https://asdacosta.github.io/portfolio-homepage/">Live Preview</a></h4>
</div>
...
Builds responsive portfolio homepage.
...
To solidify concepts of `Responsive Design` in CSS.
...
| File                               | Description                                                    |
| ---------------------------------- | -------------------------------------------------------------- |
| `src/assets/portfolio-profile.jpg` | Photo created by Bess Hamiti on [Pexels](https://pexels.com/). |
...
- [ ] Make img responsive without queries
- [ ] Add menu containing a link to other portfolios
